...
namespace SearchAndReplaceNS
{
    public class SearchAndReplace
    {
        ...
        public int replacePatternInString(ref String text, String pattern, String replacement)
        {
            int[] overlaps = calculateOverlaps(pattern);
            int[] replacementsIdxs = calculateReplacements(text, pattern, overlaps);

            text = createStringWithReplacement(text, pattern, replacement, replacementsIdxs);
            return replacementsIdxs.Length;
        }
    }
}
